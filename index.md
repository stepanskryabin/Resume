...
OpenSorce проект [MoreliaTalk](https://github.com/MoreliaTalk) мессенджер с клиент-серверной архитектурой на Python. Проект разрабатывается совместно с несколькими единомышленниками, в мои задачи входит:
    ...
    - разработал протокол взаимодействия сервера с клиентами (собственный протокол на основе JSON:API)
    - реализовал протокол в коде сервера, а так же написание других функций сервера
    - стек сервера FastAPI, SQLObject, PostgreSQL
    - организовал деплой на Google Cloud
    - написал автотесты используя unittest
    - организовал совместную работу нескольких человек в репозитории GitHub (ввёл обязательный код-ревью другими участниками).
